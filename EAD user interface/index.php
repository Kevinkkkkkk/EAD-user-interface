...
<div class="slider">
	  <div class="callbacks_container">
	      <ul class="rslides" id="slider">
	        <li><a href="login.php"><img src="images/slider1.jpg" class="img-responsive" alt=""/></a>
	         <div class="banner_desc">
				<h1></h1>
				<h2></h2>
			 </div>
	        </li>
              <li><a href=login.php><img src="images/slider2.jpg" class="img-responsive" alt=""/></a>
	          <div class="banner_desc">
				<h1></h1>
				<h2></h2>
			  </div>
	   ...
	   <div class="col-md-9 content_right">
         ...
         <?php
               ...
               if (!$result) {
                   ...
                   while ($row = mysqli_fetch_array($result)) {
               ?>
	      <div class="col-md-4 box_2"><a href="login.php">
	     	<div class="grid_1">
